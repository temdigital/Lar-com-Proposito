select
  ...
  has_function_privilege('authenticated', 'public.admin_revoke_invitation(uuid)', 'EXECUTE') as authenticated_can_revoke_invitation,
  ...
  not has_function_privilege('anon', 'public.admin_revoke_invitation(uuid)', 'EXECUTE') as anonymous_cannot_revoke_invitation,
  not has_function_privilege('anon', 'public.accept_invitation(text)', 'EXECUTE') as anonymous_cannot_accept_invitation,
